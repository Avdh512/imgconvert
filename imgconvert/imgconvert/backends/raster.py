...
def read_ppm(path: str):
    return _generic_read(path, expected_fmt="PPM")

def read_pgm(path: str):
    return _generic_read(path, expected_fmt="PGM")
...
def write_ppm(image: dict, path: str):
    return _generic_write(image, path, "PPM")

def write_pgm(image: dict, path: str):
    return _generic_write(image, path, "PGM")
